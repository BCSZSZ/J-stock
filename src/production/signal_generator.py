...
class Signal:
    ...
    industry_filter_mode: Optional[str] = None
    industry_filter_max_buy_per_day: Optional[int] = None
    industry_filter_max_total_positions: Optional[int] = None
    industry_filter_rank: Optional[int] = None
    industry_existing_positions: Optional[int] = None
    industry_total_positions_after_buy: Optional[int] = None
    industry_filter_daily_cap_blocked: bool = False
    industry_filter_total_position_blocked: bool = False
    industry_filter_blocked: bool = False
    industry_filter_filtered: bool = False
    industry_filter_reason: Optional[str] = None
