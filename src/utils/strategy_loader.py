...
def create_strategy_instance(strategy_name: str, strategy_type: str = 'entry', params: Dict[str, Any] = None):
    """
    创建策略实例
...
def get_strategy_combinations_from_lists(entry_names: List[str], exit_names: List[str]) -> List[Tuple[str, str]]:
    """
